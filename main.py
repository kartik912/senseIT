...
import random
from ultralytics import YOLO
import winsound  # Assuming this is imported elsewhere in your script
...
def object_detection():
    ...
    while True:
        ...
        # Terminate run when "Q" pressed or "quit" command detected
        if cv2.waitKey(1) == ord("q"):
            break
        else:
            # Check for "quit" command via speech recognition
            with microphone as source:
                print("Listening for 'quit' command...")
...
def main():
    ...
    while True:
        ...
        if "hello" in query:
            ...
            # img_path = 'D:\Projects\coin detection\graph-e-thon_audio\captured_photos\captured_photo.jpg'
